        ...
        >
            <Container>
                <div className="relative mx-auto max-w-2xl">
                    <svg className="absolute top-0 left-0 -mt-14 hidden md:block -ml-20" width="404" height="384" fill="none" viewBox="0 0 404 384" aria-hidden="true">
                        <rect width="280" height="220" fill="url(#1)" />
                    </svg>
                    <svg className="absolute bottom-0 right-0 -mb-56 hidden md:block -mr-52" width="404" height="384" fill="none" viewBox="0 0 404 384" aria-hidden="true">
