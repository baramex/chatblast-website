...
const variantStyles = {
    solid: {
        ...
        green: 'bg-green-500 text-white hover:text-gray-100 disabled:bg-green-300 disabled:text-gray-100 disabled:cursor-not-allowed hover:bg-green-400 active:bg-green-700 active:text-green-100 focus-visible:outline-green-600',
        red: 'bg-red-600 text-white hover:text-gray-100 disabled:bg-red-300 disabled:text-gray-100 disabled:cursor-not-allowed hover:bg-red-500 active:bg-red-800 active:text-red-100 focus-visible:outline-red-600',
    ...
    outline: {
        ...
        red: "border-red-500 text-red-600 disabled:text-red-400 hover:bg-red-50 disabled:border-red-300 disabled:bg-red-500 disabled:cursor-not-allowed hover:border-red-600 active:border-red-700 active:text-red-700 outline-none focus-visible:border-red-600",
