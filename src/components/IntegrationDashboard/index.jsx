                                        ...
                                        <nav className="h-full flex flex-col">
                                            ...
                                            <div className='px-2 space-y-1'>
                                                {navigation.map((item) => (
                                                    <Link
                                                        key={item.name}
                                                        to={item.href.replace("{id}", id)}
                                                        className={clsx(
                                                            item.href.replace("{id}", id) === document.location.pathname
                                                    ...
                                                    >
                                                        <item.icon
                                                            className={clsx(
                                                                item.href.replace("{id}", id) === document.location.pathname ? 'text-gray-500' : 'text-gray-400 group-hover:text-gray-500',
                            ...
                            <nav className="flex-1 flex flex-col">
                                <div className='px-2 space-y-1'>
                                    <div className='flex justify-between items-center px-2 mb-3'>
                                        ...
                                        <span className='text-sm text-gray-8s00'>{integration?.name}</span>
                                    </div>
                                    {navigation.map((item) => (
                                        <Link
                                            key={item.name}
                                            to={item.href.replace("{id}", id)}
                                            className={clsx(
                                                item.href.replace("{id}", id) === document.location.pathname ? 'bg-gray-100 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900',
